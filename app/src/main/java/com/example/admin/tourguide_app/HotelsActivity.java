...
public class HotelsActivity extends AppCompatActivity {
    ...
    public static final String FB_STORAGE_PATH_RE = "photos/";
    public static final String FB_DATABASE_PATH_RE = "photos";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDatabaseRef = FirebaseDatabase.getInstance().getReference(FB_DATABASE_PATH_RE);
...
//       intent.setAction(Intent.ACTION_AIRPLANE_MODE_CHANGED);
    ...
    public void onClic_upload(View v)
    {
        if(imgUrl != null)
        {
            ...
            StorageReference myStorageRef = sStorageRef.child(FB_STORAGE_PATH_RE + System.currentTimeMillis() + "," + getImageExt(imgUrl));
            ...
            myStorageRef.putFile(imgUrl).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    ResturantUpload imageupload = new ResturantUpload(txt_name.getText().toString(), txt_desc.getText().toString(), taskSnapshot.getDownloadUrl().toString());
